  ...
  generateThreadsFeeds(p) {
    ...
    if (isBeauty) {
      type1 = {
        ...
        body_ko: `아직도 비싼 돈 주고 샵 가서 관리받는 사람 있어? 진심 ${name} 알고 내 피부 인생 바뀜;; ${memo}. 화장도 1도 안 뜨고 하루 종일 촉촉해서 주변에서 피부과 어디 다니냐고 물어봄... 하 왜 이제 샀지 내 텅장 눈감아.\n\n자세한 후기랑 구매처는 첫 댓글에 남겨둘게!`,
      ...
      type2 = {
        ...
        body_ko: `10초 만에 에스테틱 다녀온 듯 물광 피부 만드는 법 방금 알아냄. 그냥 슥 바르면 1초 컷으로 피부에 쏙 흡수됨. ${name} 발색이랑 밀착력 미쳤음;; ${memo}. 똥손들도 이건 무조건 연예인 피부결 나옴.\n\n궁금한 사람들을 위해 링크 첫 댓글에 달아둠!`,
      ...
      type4 = {
        ...
        body_ko: `솔직히 피부는 화장품 장비빨인 거 다들 인정? 아직도 정착 못 하고 비싼 거 이것저것 갈아타는 사람 보면 내가 다 답답함. ${name} 하나면 고민 싹 해결되는데 왜 안 써? ${memo}. 반박 시 내 말이 맞음.\n\n정보 궁금한 사람 첫 댓글 확인해봐!`,
      ...
      type1 = {
        ...
        body_ko: `아직도 식단 챙긴다고 맛없는 거 억지로 참고 고생하는 사람 있어? 진심 ${name} 알고 내 식단 인생이 바뀜;; ${memo}. 고급 레스토랑 맛인데 간편하기까지 해서 매일 이것만 먹는 중. 하... 왜 이제 알았지 내 입맛 눈감아.\n\n자세한 후기랑 정보는 첫 댓글에 남겨둘게!`,
      ...
      type2 = {
        ...
        body_ko: `1분 만에 성수동 브런치 카페 비주얼 뚝딱 끝내는 치트키 방금 알아냄. ${name} 하나만 더해주면 1초 컷으로 비주얼 폭발함. ${memo}. 똥손들도 이건 무조건 성공함 보는 내내 침 고여 진짜;;\n\n궁금한 사람들을 위해 링크 첫 댓글에 달아둠!`,
      ...
      type4 = {
        ...
        body_ko: `솔직히 집밥이랑 식단 관리는 식재료빨인 거 다들 인정? ${name} 하나만 바꿔도 삶의 질이랑 맛이 차원이 다른데 왜 안 먹어? ${memo}. 자취생이든 직장인이든 이거 없으면 손해임. 반박 시 내 말이 맞음.\n\n정보 궁금한 사람 첫 댓글 확인해봐!`,
      ...
      type1 = {
        ...
        body_ko: `아직도 집 좁다고 스트레스 받거나 몸 고생하면서 일일이 참는 사람 있어? 진심 ${name} 알고 내 일상이 바뀜;; ${memo}. 1초 만에 깔끔해지고 삶의 질 수직상승함. 심지어 정리도 너무 편함. 하... 왜 이제 샀지 진작 살 걸.\n\n자세한 후기랑 정보는 첫 댓글에 남겨둘게!`,
      ...
      type2 = {
        ...
        body_ko: `1분 만에 고민거리 싹 해결하고 삶의 질 2배 올리는 치트키 방금 알아냄. 그냥 툭 두고 1초 컷으로 쓰기만 하면 끝남. ${name} 디자인도 깔끔하고 내구성 탄탄해서 보는 내내 쾌감 쩔어 진짜;; ${memo}.\n\n궁금한 사람들을 위해 링크 첫 댓글에 달아둠!`,
      ...
      type4 = {
        ...
        body_ko: `솔직히 일상 살림이나 자취는 장비빨인 거 다들 인정? 아직도 몸 고생하면서 옛날 방식 고집하는 사람 보면 내가 다 답답함. ${name}처럼 편하게 만들어주는 꿀템들이 널렸는데 왜 안 써? ${memo}. 자취생이든 주부든 이거 없으면 삶의 질 손해 보는 거임. 반박 시 내 말이 맞음.\n\n정보 궁금한 사람 첫 댓글 확인해봐!`,
      ...
      type1 = {
        ...
        body_ko: `아직도 손목 아프고 고생하면서 일일이 다 하는 사람 있어? 진심 ${name} 알고 내 인생이 바뀜;; ${memo}. 도마 꺼내고 썰고 사방에 튀는 거 스트레스였는데 이건 그냥 쓱 쓰면 1초 만에 끝남. 심지어 정리도 너무 편해서 설거지도 확 줄어듦. 하... 왜 이제 샀지 내 손목 눈감아.\n\n자세한 후기랑 정보는 첫 댓글에 남겨둘게!`,
      ...
      type2 = {
        ...
        body_ko: `1분 만에 준비랑 요리 한 방에 뚝딱 끝내는 법 방금 알아냄. 그냥 툭 얹고 꾹 누르면 1초 컷으로 완벽하게 끝남. ${name} 써보니까 손재주 없는 똥손들도 이건 무조건 전문가 퀄리티 나옴. ${memo}. 내구성도 탄탄하고 깔끔해서 보는 내내 쾌감 쩔어 진짜;;\n\n궁금한 사람들을 위해 링크 첫 댓글에 달아둠!`,
      ...
      type4 = {
        ...
        body_ko: `솔직히 일상 살림이나 요리는 장비빨인 거 다들 인정? 아직도 손목 아프게 구식 방법 고집하는 사람 보면 내가 다 답답함. ${name}처럼 안전하고 편하게 만들어주는 꿀템들이 널렸는데 왜 안 써? ${memo}. 자취생이든 주부든 이거 없으면 주방에서 시간 낭비하는 거임. 반박 시 내 말이 맞음.\n\n정보 궁금한 사람 첫 댓글 확인해봐!`,
